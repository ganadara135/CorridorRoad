...
- add watertight solid outputs as a final corridor-result stage for selected corridor, Region, drainage, structure, and component targets
...
- prepare terrain-inclusive road simulation models from validated corridor, terrain, drainage, structure, and component outputs
...
- simulation-ready watertight output should be assembled from independently validated terrain, road-body, component, drainage, and structure solids before any optional final boolean composition is attempted
...
| Drainage physical body | topology-first | Lined ditches, concrete channels, culverts, headwalls, inlets, and outlets need closed component body topology. |
...
5. Generate independent watertight solid targets for road body, component layers, drainage bodies, and structure bodies.
...
- define solid targets for whole-corridor, selected Region, drainage, structure, and component body outputs
- support terrain-inclusive whole-road simulation packages by collecting road-body, component, drainage, structure, and terrain-boundary solid outputs
...
- validate independent road-body, component, drainage, structure, and terrain-boundary solids
