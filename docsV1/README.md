...
- [V1_INTERSECTION_SCOPE_AND_IMPROVEMENT_PLAN.md](./V1_INTERSECTION_SCOPE_AND_IMPROVEMENT_PLAN.md) - the three supported intersection kinds, what was removed, and the improvements the remaining flow needs
...
- [V1_ROUTE_SEPARATION_AND_REGION_CRITERIA.md](./V1_ROUTE_SEPARATION_AND_REGION_CRITERIA.md) - when a road needs its own document and when a station span needs a Region row
...
- [V1_SIDE_SLOPE_REVIEW_UX_PLAN.md](./V1_SIDE_SLOPE_REVIEW_UX_PLAN.md) - active targeted plan for result-backed ordinary-road and Intersection Side Slope review
