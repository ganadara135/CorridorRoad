...
# Root GUI entrypoint that forwards to the namespaced implementation.
import os
import sys
...
# Import for side effects: registers CorridorRoadWorkbench.
from freecad.Corridor_Road import init_gui  # noqa: F401,E402
