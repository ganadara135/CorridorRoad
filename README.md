...
`1.0.1` also marks the public naming transition from `Corridor Road` to `Parametric Road`. The internal Python package, FreeCAD Mod folder, command ids, and v1 source ids remain unchanged for compatibility.
