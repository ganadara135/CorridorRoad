...
# Preferred canonical task-panel module path.
        ...
        try:
            ...
            try:
                marker_objs = [
                    ...
                    if str(getattr(o, "Name", "") or "").startswith(CORRIDOR_SKIP_MARKER_NAME)
            ...
            try:
                segment_objs = [
                    o
                    for o in list(getattr(self.doc, "Objects", []) or [])
                    if str(getattr(o, "Name", "") or "").startswith(CORRIDOR_SEGMENT_NAME)
                    and getattr(o, CORRIDOR_CHILD_LINK_PROPERTY, None) == cor
                ]
            except Exception:
                segment_objs = []
