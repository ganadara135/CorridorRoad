...
def run():
    ...
    _assert(int(getattr(cor, "StructureSegmentCount", 0) or 0) >= 2, "CorridorLoft should split across structure ranges")
    ...
    _assert("corridorModes=" in cor_status, "CorridorLoft status missing corridor mode summary")
    _assert("skip_zone=2" in cor_status, "CorridorLoft status missing skip_zone count")
    _assert("split_only=1" in cor_status, "CorridorLoft status missing split_only count")
    _assert("skipZones=" in cor_status, "CorridorLoft status missing skip-zone summary")
